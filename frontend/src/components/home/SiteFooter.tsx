    ...
    <footer id="contact" className="bg-navy text-white">
      <div className="container-trust py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-bold uppercase tracking-[0.15em] text-gold">{t("home.footer.quickTitle", "Quick Links")}</h3>
          ...
          {/* Discover */}
          <div>
            <h3 className="text-sm font-bold uppercase tracking-[0.15em] text-gold">{t("home.footer.discoverTitle", "Discover")}</h3>
            <ul className="mt-5 space-y-3">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-sm font-bold uppercase tracking-[0.15em] text-gold">{t("home.footer.contactTitle", "Contact")}</h3>
            <ul className="mt-5 space-y-4 text-sm text-white/80">
              ...
              <li className="flex gap-3">
                ...
                <a href={`mailto:${t("home.footer.email")}`} className="transition hover:text-gold">
                  {t("home.footer.email")}
                </a>
              </li>
              <li className="flex gap-3">
