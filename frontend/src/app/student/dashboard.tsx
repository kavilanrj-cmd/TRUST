...
export const metadata = {
  title: "Neelakannu Educational Trust - Student Dashboard",
  description: "Student dashboard for Neelakannu Educational Trust",
};

export default function StudentDashboard() {
  const [user, setUser] = useState<{ id: string; name: string; email: string; role: string; emailVerified: boolean | null } | null>(null);
  const [application, setApplication] = useState<{ applicationId: string; status: string; personalDetails?: any; address?: any; parentGuardian?: any; academicDetails?: any; financialDetails?: any; scholarshipProgram?: { name: string } | null; createdAt: string; submittedAt: string | null } | null>(null);
        ...
        <div className="w-full max-w-2xl space-y-8">
          ...
          <div className="mt-8 border-t pt-8 text-sm text-muted-foreground">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {status === "SUBMITTED" && (
                <a href="/" className="group py-2 flex items-center justify-center rounded-lg border border-gray-200 hover:bg-primary/5 transition-colors">
          ...
          <div className="mt-6">
            <button
              onClick={() => fetch("/api/auth/logout", { method: "POST", credentials: "include" })}
