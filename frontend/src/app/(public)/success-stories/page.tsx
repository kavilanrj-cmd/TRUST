      ...
      <section className="container-trust section-pad">
        <Reveal>
          <header className="mx-auto max-w-2xl text-center">
            ...
            <h1 className="h2-section mt-4">{t("home.successStories.title", "Stories of Achievement")}</h1>
        ...
        {!checked ? (
                ...
                <figure className="card-trust flex h-full flex-col rounded-2xl bg-white p-7 transition duration-300 hover:-translate-y-1 hover:shadow-[0_16px_40px_-18px_rgba(22,41,74,0.3)] dark:bg-[#131a2e]">
                  ...
                  <div className="mt-6 flex items-center gap-4 border-t border-border pt-5">
                    {story.imageUrl ? (
                      ...
                      <span className="flex h-12 w-12 items-center justify-center rounded-full bg-navy font-serif text-lg font-bold text-gold">
                        {story.name.charAt(0).toUpperCase()}
                      </span>
                    )}
                    <div>
                      <figcaption className="font-semibold text-navy dark:text-white">{story.name}</figcaption>
          ...
          <div className="card-trust mx-auto mt-14 max-w-2xl rounded-2xl bg-white p-10 text-center dark:bg-[#131a2e]">
            <span className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gold-soft text-navy dark:text-gold">
            ...
            <p className="mt-5 font-serif text-2xl font-bold text-navy dark:text-white">Become a success story</p>
