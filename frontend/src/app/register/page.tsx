    ...
    <div>
      ...
      >
        ...
        <input
          ...
          className={`w-full rounded-lg border bg-white py-3 pl-12 pr-12 text-[#0A1F44] shadow-sm outline-none transition-all duration-300 placeholder:text-slate-400 border-slate-300 ${
              error
                ? "border-red-400 focus:border-red-400 focus:ring-4 focus:ring-red-100"
                : "focus:border-[#D4AF37] focus:ring-4 focus:ring-[#D4AF37]/30"
            }`}
        ...
        {value.length > 0 && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1.5 text-slate-500 transition-colors hover:text-[#0A1F44]"
          >
...
export default function RegisterPage() {
  ...
  const inputCls =
    "w-full rounded-lg border px-4 py-3 text-[#0A1F44] bg-white placeholder:text-slate-400 border-slate-300 focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/30";

  return (
    <section className="relative min-h-screen w-full bg-[#F7F7F5] px-4 py-12">
      ...
      >
        ...
        <motion.main
          className="flex w-full flex-col justify-center px-6 py-10 sm:px-10 lg:min-h-screen lg:py-16 text-[#0A1F44]"
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#0A1F44]">Full Name</label>
                <input
                  type="text"
                  value={name}
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#0A1F44]">Email</label>
                <input
                  type="email"
                  value={email}
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#0A1F44]">Password</label>
                <PasswordField
                  value={password}
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#0A1F44]">Confirm Password</label>
                <PasswordField
              ...
              {capsLockWarning && (
                <div
                  className="rounded-xl border border-yellow-300 bg-yellow-50 p-3 shadow-sm"
                ...
                >
                  <span className="inline-flex items-center gap-2">
                    ...
                    <span className="text-yellow-700 text-sm font-medium">Caps Lock is ON</span>
                  </span>
                </div>
              )}
            ...
            <div className="text-center">
              <p className="text-sm text-slate-700">
                ...
                <Link href="/login" className="font-semibold text-[#D4AF37] underline underline-offset-2 hover:text-[#B8902F]">
                  Login
                </Link>
              </p>
            </div>
